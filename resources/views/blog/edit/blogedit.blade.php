        ...
        <div class="content-left">
            <div class="tsb">
                ...
                <div class="blog" style="width: 563px;">
                    ...
                    <form style="padding: 10px" action="/blog/edit/{{$blog->id}}" method="post" enctype="multipart/form-data">
...
характера</p>
                        ...
                        <span style="display: inline-block;border-width:0;width:220px;">
                                  {{--<a href="#">X</a>--}}
                            <img id="image" onclick="loadImage()" src="/storage/{{$blog->filename}}" style="width: 220px;background-color: #f0f0f0;">
...
<label id="loadfile" for="uploadbtn" style="position: relative;    left: 34px;
    top: -150px;display: none">Загрузить изображение</label>
                        ...
                        <input type="submit" style="border-width: 0;width: 418px;height: 50px;font-weight: bold;font-size: 18pt;position: relative;display: block;box-sizing: border-box;color: white;background-color: orange;margin-top: 30px;margin-bottom: 30px;border-radius: 7px;" value="Сохранить статью"/>
                    </form>
