    ...
    <div style="margin: 10px;padding: 10px;background-color: #696969;">
        <form enctype="application/x-www-form-urlencoded" method="post">
            ...
            <div class="form-group category">
                ...
                <select id="category" class="form-control" name="category" style="padding-left:3px;width: 100%;margin-bottom: 15px;border: 1px solid;border-width: 1px;border-radius: 3px;height: 34px;font-size: 13pt;" size="1">
